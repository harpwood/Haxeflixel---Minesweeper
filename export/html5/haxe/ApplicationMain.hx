...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("HxMinesweeper", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("HxMinesweeper", null, 1024, 768);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "HxMinesweeper";
		app.meta["name"] = "HxMinesweeper";
